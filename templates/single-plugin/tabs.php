<?php
// tabs.php - Single plugin with tabs layout (featured image + categories + tags)
if ( ! have_posts() ) {
    return;
}
the_post();
...
<article class="ph-single">
  ...
  <div class="ph-tabs">
    <div class="ph-tabs-nav">
      <button type="button" data-tab="ph-tab-desc" class="is-active"><?php esc_html_e('Description','pluginhub-pro'); ?></button>
      <?php if ( $shots ) : ?>
        <button type="button" data-tab="ph-tab-screens"><?php esc_html_e('Screenshots','pluginhub-pro'); ?></button>
      <?php endif; ?>
      <?php if ( $changes ) : ?>
        <button type="button" data-tab="ph-tab-change"><?php esc_html_e('Changelog','pluginhub-pro'); ?></button>
      <?php endif; ?>
    </div>

    <div class="ph-tabs-content is-active" id="ph-tab-desc">
      <div class="ph-single-body">
        <?php the_content(); ?>
      </div>
    </div>

    <?php if ( $shots ) : ?>
    <div class="ph-tabs-content" id="ph-tab-screens">
    ...
    <?php if ( $changes ) : ?>
    <div class="ph-tabs-content" id="ph-tab-change">
      <pre class="ph-changelog"><?php echo esc_html( $changes ); ?></pre>
    </div>
    <?php endif; ?>
  </div>
</article><?php
// tabs.php - Single plugin with tabs layout (featured image + tags)
if ( ! have_posts() ) {
    return;
}
the_post();
